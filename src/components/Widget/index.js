...
import {
    ...
    clearIndentData,
    addUserData,
    addAgainstSampleIndentPopup,
    addAgainstSampleIndentData,
    sendCustomActionText,
    addPOConfirmationPopup,
    addPOConfirmationData
} from "actions";
        ...
        if (!socket.isInitialized()) {
            ...
            socket.on("bot_uttered", botUttered => {
                ...
                if (botUttered.type === "action") {
                    ...
                    if (botUttered.actionType === "CLEAR_INDENT_DATA") {
                        dispatch(clearIndentData());
                    }
...
*/
    ...
    dispatchMessage(message) {
        ...
        } else if (message.component == "popup" && message.subComponent == "againstSampleIndent") {
            console.log("ADDING INDENT DATA");
            this.props.dispatch(addAgainstSampleIndentData(message.payload));
            this.props.dispatch(addAgainstSampleIndentPopup(message.payload.text));
        } else if (message.component == "popup" && message.subComponent == "poCofirmationPopup") {
            console.log("ADDING PO Confirmation DATA");
            this.props.dispatch(addPOConfirmationData(message.payload.data));
            this.props.dispatch(addPOConfirmationPopup(message.payload.text));
        } else {
            // some custom message
            const props = message;
