...
export default function () {
  const INITIAL_STATE = {
    selectedData: [],
    savedConfirmationData: [],
    confirmationData: []
  };

  return function reducer(state = INITIAL_STATE, action) {
    console.log("PO Confirmation reducer called with action : ", action);
    switch (action.type) {
      ...
      case actionTypes.SELECT_PO_CHANGES: {
        return { ...state, selectedData: action.payload };
      }

      case actionTypes.ADD_PO_CONFIRMATION_DATA: {
